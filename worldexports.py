...
#------------------------EXPORTS--------------------------
    ...
    if analysis == "World Exports":
        ...
        with open(f"graphs2/exp/exports_{selected_year}.html", "r", encoding="utf-8") as file:
            plot_html = file.read()
    
        st.components.v1.html(plot_html, height=600, width=1000)
        
        with open(f"graphs2/exp/top_exports_{selected_year}.html", "r", encoding="utf-8") as file:
            plot_html = file.read()
...
#------------------------IMPORTS--------------------------
        ...
        with open(f"graphs/imp/imports_{selected_year}.html", "r", encoding="utf-8") as file:
            plot_html = file.read()
